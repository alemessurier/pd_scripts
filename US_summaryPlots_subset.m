function US_summaryPlots_subset(dF_byDS,stimFrame,dF_byPressure,DCsweep,...
    pressSweep,DC_labels,pressure_labels,ops,stat,tif_1100,ROI_masks,poststim,cellNames)
...
plot_US_byROI_params( samp_rate,stimFrame,DCsweep,dF_byDS,pressSweep,dF_byPressure,cellNames(idx_pos),pressure_labels,DC_labels)
plot_US_byROI_params( samp_rate,stimFrame,DCsweep,dF_byDS,pressSweep,dF_byPressure,cellNames(idx_neg),pressure_labels,DC_labels)
