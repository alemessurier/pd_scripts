...
[MovieData, Metadata] = LoadTIFF_SI38(imPath);     
% [Metadata] = ReadTIFFHeader_SI5(Metadata);
[MovieDataGreen, MetaDataGreen] = ExtractFrames_TIFF_SI38(MovieData, Metadata,1:2:(size(MovieData,3)));
imNameInds=strfind(imPath,'.');
WriteTIFF(MovieDataGreen, MetaDataGreen, strcat(imPath(1:(imNameInds-1)),'_grch.tif'));

[MovieDataRed, MetaDataRed] = ExtractFrames_TIFF_SI38(MovieData, Metadata,2:2:(size(MovieData,3)));
