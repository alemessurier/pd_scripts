function [ROI_positions,neuropil_mask]=label_ROIs_SI2019(dir_ROIs,ROI_positions,ring,gap)
...
for K=1:30:length(stackNames);  % loop every 5 movie files
    imPath=strcat(dir_ROIs,stackNames{K});
    [im, ~] = LoadTIFF_SI2019(imPath);
