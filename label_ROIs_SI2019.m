function [ROI_positions,neuropil_mask]=label_ROIs_SI2019(dir_ROIs,dir_ROI_positions,ring,gap)
...
for K=1:length(stackNames);  % loop every 5 movie files
    ...
    ROIs_new=define_ROI_masks_SI2019(im,ROI_positions); % ROI(:,:,1)=zeros(512,512) in function
...
save([dir_ROI,'\ROI_positions.mat'],'ROI_positions')
