...
%% IC622
paths_2p{1}={'/Users/aml717/data/reduced/IC622/20220718/suite2p/plane0/',...
    '/Users/aml717/data/reduced/IC622/20220719/suite2p/plane0/',...
    '/Users/aml717/data/reduced/IC622/20220720/suite2p/plane0/'};

matchFilePath{1}='/Users/aml717/data/reduced/IC622/IC622_roiMatch.mat';
behaviorPath{1}='/Users/aml717/data/reduced/IC622/retrieve.mat';
% for i=1:length(paths_2p)
% pupCall_imaging_pipeline_multiISI_spikes(paths_2p{i},0);
% end
%% IC623
paths_2p{2}={'/Users/aml717/data/reduced/IC623/20220718/suite2p/plane0/',...
    '/Users/aml717/data/reduced/IC623/20220719/suite2p/plane0/',...
    '/Users/aml717/data/reduced/IC623/20220720/suite2p/plane0/'};
% for i=1:length(paths_2p)
% pupCall_imaging_pipeline_multiISI_spikes(paths_2p{i},0);
% end
matchFilePath{2}='/Users/aml717/data/reduced/IC623/IC623_roiMatch.mat';
behaviorPath{2}='/Users/aml717/data/reduced/IC623/retrieve.mat';
%% IC603 field 1
paths_2p{3} = {'/Users/aml717/data/reduced/IC603/20220627/suite2p/plane0/',...
...
matchFilePath{3} ='/Users/aml717/data/reduced/IC603/field1/IC603_matchROI_field1.mat';
behaviorPath{3}='/Users/aml717/data/reduced/IC603/retrieve.mat';
%% IC603 field 2
...
%% IC 617 field 1
paths_2p{5} = {'/Users/aml717/data/reduced/IC617/20220703/suite2p/plane0/',...
...
matchFilePath{5} ='/Users/aml717/data/reduced/IC617/field1/IC617_field1_roiMatch.mat';
behaviorPath{5} ='/Users/aml717/data/reduced/IC617/retrieve.mat';
%% IC 617 field 2
...
%% PS526 field 1
paths_2p{7} = {'/Users/aml717/data/reduced/PS526/20220628/field1/suite2p/plane0/',...
    '/Users/aml717/data/reduced/PS526/20220629/field1/suite2p/plane0/',...
    '/Users/aml717/data/reduced/PS526/20220630/suite2p/plane0/'};
matchFilePath{7} ='/Users/aml717/data/reduced/PS526/PS526_field1_roiMatch.mat';
