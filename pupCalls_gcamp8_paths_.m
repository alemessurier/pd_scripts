...
matchFilePath{3} ='/Users/aml717/data/reduced/IC603/IC603_matchROI_field1.mat';
%% IC603 field 2
...
matchFilePath{4} ='/Users/aml717/data/reduced/IC603/IC603_matchROI_field2.mat';
...
matchFilePath{5} ='/Users/aml717/data/reduced/IC617/IC617_field1_roiMatch.mat';
%% IC 617 field 2
...
matchFilePath{6} ='/Users/aml717/data/reduced/IC617/IC617_field2_roiMatch.mat';
% for i=1:length(paths_2p)
% pupCall_imaging_pipeline_multiISI_spikes(paths_2p{i},0);
% end
